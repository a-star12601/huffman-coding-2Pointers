...
import com.capillary.app.db.IDataBase;
import com.capillary.app.db.SQLiteDB;
 ...
 */
public class DBHybridHuffmanZipperUnzipper implements IZipperUnzipper {
    /**
     * The FileRead object
     */
    FileRead fr;
     ...
     */
    public DBHybridHuffmanZipperUnzipper(){
     ...
     */
    public DBHybridHuffmanZipperUnzipper(FileRead fr, ICompressionTree cTree, ICompression comp,
...
private static List<Map.Entry<String, Integer> > getSortedList(Map<String ,Integer> map){
    ...
    public void compress(String originalFile, String compressedFile){
        ...
        try {
            ...
            fw.writeCompDB(encodedBytes,compressedFile, fileHash);
        } catch (IOException e) {
    ...
    public String decompress(String compressedFile, String decompressedFile) {
        try {
            IDataBase db=new SQLiteDB();
            ComplexReturnType crt = fr.readDecompDB(compressedFile);
    ...
    private static byte[] getMapBytes(Map<String, Integer> mp) {
